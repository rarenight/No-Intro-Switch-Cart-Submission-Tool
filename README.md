...
First, dump your cart using the latest version of [nxdumptool-rewrite](https://github.com/DarkMatterCore/nxdumptool/releases) onto your SD card or to your PC via USB using the default dump settings. You can dump a Switch cart via USB by [joining](https://discord.gg/SCbbcQx) the nxdumptool Discord server and following [this](https://discord.com/channels/770369219266084945/770376156867723295/1198742171851956234) tutorial by Whovian9639. 
